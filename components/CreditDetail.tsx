                    ...
                    <div className="pt-8 border-t border-slate-50">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                             <div className="space-y-4 p-8 bg-slate-50/50 rounded-[2.5rem] border border-slate-100 shadow-inner">
                                ...
                                <EditableItem label="Cédula" name="ref1Cedula" value={editFormData.ref1Cedula} isEditing={isEditing} onChange={e=>setEditFormData({...editFormData, ref1Cedula: e.target.value})} />
                                <EditableItem label="Fecha Expedición" name="ref1FechaExpedicion" value={editFormData.ref1FechaExpedicion} isEditing={isEditing} onChange={e=>setEditFormData({...editFormData, ref1FechaExpedicion: e.target.value})} type="date" />
                                <EditableItem label="Fecha Nacimiento" name="ref1FechaNacimiento" value={editFormData.ref1FechaNacimiento} isEditing={isEditing} onChange={e=>setEditFormData({...editFormData, ref1FechaNacimiento: e.target.value})} type="date" />
                             ...
                             <div className="space-y-4 p-8 bg-slate-50/50 rounded-[2.5rem] border border-slate-100 shadow-inner">
                                ...
                                <EditableItem label="Cédula" name="ref2Cedula" value={editFormData.ref2Cedula} isEditing={isEditing} onChange={e=>setEditFormData({...editFormData, ref2Cedula: e.target.value})} />
                                <EditableItem label="Fecha Expedición" name="ref2FechaExpedicion" value={editFormData.ref2FechaExpedicion} isEditing={isEditing} onChange={e=>setEditFormData({...editFormData, ref2FechaExpedicion: e.target.value})} type="date" />
                                <EditableItem label="Fecha Nacimiento" name="ref2FechaNacimiento" value={editFormData.ref2FechaNacimiento} isEditing={isEditing} onChange={e=>setEditFormData({...editFormData, ref2FechaNacimiento: e.target.value})} type="date" />
